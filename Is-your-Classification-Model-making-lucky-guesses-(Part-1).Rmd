...
#Compute the accuracy of the model and compare to the accuracy of a random guess classifier.
train_modelout = rxPredict(ML_model, data = trainingdata, outData = NULL, overwrite = TRUE,
          writeModelVars = TRUE)
#class(train_modelout) #"RxXdfData"

#create a data frame containing 2 columns with actual and predicted values
